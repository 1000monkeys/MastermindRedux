...
class TextInput(UIElement):
    def __init__(self, screen: Screen, assets: Assets, text: str, position: Tuple, text_color: str, background_color: Tuple=None, border_color: Tuple=None, border_width: int=None, max: int=None):
